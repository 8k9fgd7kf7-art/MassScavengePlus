...
<div id="${APP.modalId}">
    ...
    function applyQuickPreset(index) {
        ...
        const target = quickTargetParts(item.type, item.value);
        if (!target) return;
...
<div id="mspQuickModal" class="msp-quick-modal-overlay">
    ...
    async function calculateAll() {
        ...
        try {
            ...
            if (times.off > 24 || times.def > 24) {
                notifyInfo('Hinweis: Mindestens eine gewünschte Laufzeit liegt über 24 Stunden.');
            }
